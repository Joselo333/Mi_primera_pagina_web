...
<html lang="es">
    ...
    <body class="gradient-background">
        <main class="container gradient-container p-5" >
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                        ...
                        <li class="ms-3"><a class="text-primary" href="https://www.facebook.com/Kiru-Sushi-Copiap%C3%B3-100342885368123" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                        </svg></a></li>
                        <li class="ms-3"><a class="text-success" href="https://wa.me/+56987614788/?text=Hola+Te+Contactas+Con+KiruSushi!!" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                        ...
                        <li class="ms-3"><a class="text-danger" href="https://www.instagram.com/sushi.kiru/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
